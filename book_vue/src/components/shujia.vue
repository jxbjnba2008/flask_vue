<template>
    <div class="yuedu">
        <b-button type="primary" size="small" plain @click="addbook">{{flag?'加入书架':'撤出书架'}}</b-button>
        <b-button type="danger" size="small" @click="read">{{flag?'立即阅读':'继续阅读'}}</b-button>
    </div>
</template>
<script>
